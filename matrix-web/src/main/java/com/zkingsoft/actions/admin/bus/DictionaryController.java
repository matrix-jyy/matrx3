...
public class DictionaryController extends BaseController {
	...
	public static final String BEV = "BusCatalog_BEV";

	public static final String fnCode = "dictionary";
	...
	public @ResponseBody AjaxResult showList(BusCatalog busCatalog, PaginationVO pageVo) {
		...
		busCatalog.setCataType(BusinessConstance.CATA_DICTIONARY);
	...
	public @ResponseBody AjaxResult addOrModify(BusCatalog busCatalog) {
		if (busCatalog.getCataId() != null) {
			...
			AjaxResult result = modify(busCatalogService, WebUtil.getSessionAttribute(BEV), busCatalog, "数据字典");
			WebUtil.removeSessionAttribute(BEV);
			return result;
		} else {
			authorityAdapter.isBtnPermitted(add);
			busCatalog.setCataType(BusinessConstance.CATA_DICTIONARY);
			return add(busCatalogService, busCatalog, "数据字典");
		}
	}
