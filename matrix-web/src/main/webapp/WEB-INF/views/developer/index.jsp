					...
					<li><a href="#"><i class="fa fa-table"></i> <span
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem"
								href="${path }/developer/redirect/sysFunction-list">功能管理</a></li>
							<li><a class="J_menuItem"
								href="${path }/developer/redirect/sysBtn-list">按钮管理</a></li>
						</ul></li>
				</ul>
			</div>
		</nav>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row J_mainContent" id="content-main">
				<iframe class="J_iframe" name="iframe0" width="100%" height="100%"
					src="${path}/developer/redirect/welcome" frameborder="0" data-id="index_v1.html"
					seamless></iframe>
			</div>
			<div class="footer">
