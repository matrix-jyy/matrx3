...
<body class="gray-bg">
	...
	<!-- 搜索框部分start -->
		<form class="form-inline" id="serchform">
			<div class="form-group mr-20">
				...
				<input name="platName" type="text" class="form-control">
			</div>
			<div class="form-group mr-20">
				<label for="exampleInputEmail2">CODE</label>
				<input name="platCode" type="text" class="form-control" >
			</div>
	...
	<div class="row" >
		...
		<div class="option-bar" >
			<button onclick="myGrid.delItems('platId')" type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash" ></i>批量删除</button>
		...
		<table id="mgrid" >
			<thead>
				<tr>
					...
					<th data-field="platName" data-sortable="true">平台名称</th>
					<th data-field="platCode" data-sortable="true">code</th>
					<th data-align="center"  data-width="150px" data-field="platId" data-formatter="buidOperate">操作</th>
				</tr>
			</thead>
		</table>
	</div>
	...
	var myGrid;
		$(function(){
			 myGrid=MGrid.initGrid({
				 url:"${path}/admin/sysPlat/showList",
				 delUrl:"${path}/admin/sysPlat/del"
			 });
		});
		...
		function openAdd() {
			layer.open({
				...
				content : [ '${path}/admin/sysPlat/editForm', 'no' ]
			}); 
		}
		//打开编辑界面
		function openEdit(id) {
			layer.open({
				...
				area : [ MUI.SIZE_S, '300px' ],
				maxmin : true,
				content : [ '${path}/admin/sysPlat/editForm?id=' + id,'no' ]
			});
		}
	</script>
</body>
