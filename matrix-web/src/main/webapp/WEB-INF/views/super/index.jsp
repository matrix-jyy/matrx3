					...
					<li class="nav-header">
						<div class="dropdown profile-element">
							<span><img alt="image" class="img-circle"
								src="${path }/resource/images/profile_small.jpg" /></span> <a
					...
					<li><a href="#"><i class="fa fa-table"></i> <span
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem"
								href="${path }/super/redirect/sysCompany-list">公司管理</a></li>
							<li><a class="J_menuItem"
								href="${path }/super/redirect/admin-list">公司管理员管理</a></li>
							<li><a class="J_menuItem"
								href="${path }/super/redirect/sysPlat-list">应用管理</a></li>
						</ul></li>
				</ul>
			</div>
		</nav>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
				...
				<nav class="navbar navbar-static-top" role="navigation"
					...
					<div class="navbar-header">
						<a class="navbar-minimalize minimalize-styl-2 btn btn-primary "
							...
							class="text-primary welcomtitle">欢迎使用ZkingMatrix</span>
					</div>
			...
			<div class="row J_mainContent" id="content-main">
				<iframe class="J_iframe" name="iframe0" width="100%" height="100%"
					src="${path }/super/redirect/welcome" frameborder="0"
					data-id="index_v1.html" seamless></iframe>
			</div>
			<div class="footer text-right" style="color: #676a6c;" ><matrix:copyright></matrix:copyright></div>
			</div>
		</div>  
		<!--右侧部分结束-->
		<!--右侧边栏开始-->
