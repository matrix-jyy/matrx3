...
<div class="ibox-content">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label">导航栏分类名称<span class="text-danger">*</span></label>
			<div class="col-sm-4">
...
<script type="text/javascript"
	...
	var myForm=MForm.initForm({
		invokeUrl:"${path}/admin/webTypeNav/addOrModify",
