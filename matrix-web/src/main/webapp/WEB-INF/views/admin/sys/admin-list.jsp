	...
	<div class="row" >
		...
		<div class="option-bar" >
			<matrix:btn value="user:dels">
				<button  type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash" ></i>批量删除</button>
			</matrix:btn>
	...
	var myGrid;
		...
		function openEdit(id) {
			layer.open({
				...
				area : [ MUI.SIZE_L, '500px' ],
				maxmin : true,
				content : [ '${path}/admin/editForm?id=' + id]
			});
		}
		</matrix:btn>
	</script>
