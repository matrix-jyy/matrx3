...
<div class="ibox-content">
		...
		<div class="form-group">
			...
			<label class="col-sm-2 control-label">用户角色<span class="text-danger">*</span></label>
			<div class="col-sm-4">
				<select class="form-control autoFull select2" dataType="*" nullmsg="角色不能为空" 
				multiple="multiple"
...
<script type="text/javascript"
	...
	var myForm=MForm.initForm({
		invokeUrl:"${path}/admin/addOrModify",
