    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            html.push('</div>',
                ...
                '<input class="btn-go" id="page" type="number" min="1" value="'+this.options.pageNumber+'" max="'+this.totalPages+'" > <button class="btn-go" onclick="MGrid.goPage(this,'+this.totalPages+',\''+this.$header.context.id+'\')" >GO</button>'+
